<?php
/*
 * Script ini menampilkan dan mengelola data tagihan listrik untuk admin dan pelanggan PLN.
 * Alur:
 * - Memastikan koneksi database aktif dan session dimulai
 * - Jika admin, menampilkan seluruh data tagihan dan fitur generate/hapus tagihan
 * - Jika pelanggan, menampilkan tagihan milik sendiri dan fitur pembayaran
 * - Menampilkan tabel data tagihan dengan aksi sesuai level user
 * - Terdapat tombol untuk cetak tagihan dan kembali ke dashboard
 */
