<?php
/*
 * Script ini menampilkan dan mengelola data penggunaan listrik pelanggan untuk admin PLN.
 * Alur:
 * - Memastikan koneksi database aktif dan user adalah admin
 * - Mengambil data penggunaan dari database
 * - Menampilkan tabel data penggunaan dengan fitur tambah, edit, dan hapus
 * - Terdapat tombol kembali ke dashboard
 */
include '../config/koneksi.php';
include '../config/akses_admin.php';
$query = "SELECT pg.*, pl.nama FROM penggunaan pg JOIN pelanggan pl ON pg.id_pelanggan = pl.id_pelanggan ORDER BY tanggal DESC";
