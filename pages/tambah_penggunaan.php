...
$id = $id_pelanggan = $bulan = $tahun = $meter_awal = $meter_akhir = '';
$tanggal = '';
...
if (isset($_GET['id'])) {
    ...
    if ($edit) {
        $id_pelanggan = isset($edit['id_pelanggan']) ? $edit['id_pelanggan'] : '';
        $bulan = isset($edit['bulan']) ? $edit['bulan'] : '';
        $tahun = isset($edit['tahun']) ? $edit['tahun'] : '';
        $meter_awal = isset($edit['meter_awal']) ? $edit['meter_awal'] : '';
        $meter_akhir = isset($edit['meter_akhir']) ? $edit['meter_akhir'] : '';
